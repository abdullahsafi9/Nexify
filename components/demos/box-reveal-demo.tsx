  ...
  return (
    <div className="h-full w-full items-center justify-center ml-10 overflow-hidden pt-8 space-y-2">
      <BoxReveal boxColor={"#3b82f6"} duration={0.5}>
        ...
        <p className="text-3xl text-gray-500 font-semibold">1. Connect</p>
      </BoxReveal>
      ...
      <BoxReveal boxColor={"#3b82f6"} duration={0.5}>
        <p className="text-3xl text-gray-500 font-semibold">2. Collaborate</p>
      </BoxReveal>
      ...
      <BoxReveal boxColor={"#3b82f6"} duration={0.5}>
        <p className="text-3xl text-gray-500 font-semibold">3. Create</p>
      </BoxReveal>
